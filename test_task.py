...
def goodle_api_auth():
    ...
    CREDENTIALS_FILE = 'sales-test-377420-65aeef9c36de.json'
...
def read_spreadsheet_values(service):
    ...
    spreadsheet_id = '1ILfOFiurHmeWs1gjLj2B3kqXJ020TZ4TMjJPdFp1SWg'
...
def get_db_connection():
    conn = psycopg2.connect(
        dbname=environ.get("POSTGRES_DB",'sales'), 
        user=environ.get("POSTGRES_USER",'manager'),
        password=environ.get("POSTGRES_PASSWORD",'test'), 
